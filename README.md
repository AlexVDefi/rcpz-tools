...
> Looking for the **character and animation viewer** (dress a survivor, play the game's clips,
> export a still, sprite sheet, or GIF)? It now lives in the separate **PZ Survivor Studio**
> app. Grab it from the same [Releases](https://github.com/AlexVDefi/rcpz-tools/releases) page.
...
1. Grab `pz-icon-maker-<version>-win-x64.zip` from the
   [Releases](https://github.com/AlexVDefi/rcpz-tools/releases) page and unzip it.
